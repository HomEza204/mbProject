...
import 'package:public_toilets/screens/home/description_page.dart';
...
class ToiletListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return RawMaterialButton(
      onPressed: () {
        Navigator.push(context, MaterialPageRoute(builder: (context) => DescriptionPage(name: toilet.name,reviews: toilet.reviews,)));
      },
      child: Card(
